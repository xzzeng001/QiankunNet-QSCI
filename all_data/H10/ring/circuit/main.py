...
# Construct UCJ operator
#n_reps = 2
#ucj_op = ffsim.UCJOpSpinBalanced.from_parameters(t2, norb=norb, n_reps=n_reps)
#ucj_op = ffsim.UCJOpSpinBalanced.from_t_amplitudes(t2, n_reps=n_reps,tol=1e-5)
...
backend = GenericBackendV2(2 * norb, basis_gates=['rx','ry','rz','cx','h','x'])
...
print(f"Energy at initialization: {fun(params)}")
