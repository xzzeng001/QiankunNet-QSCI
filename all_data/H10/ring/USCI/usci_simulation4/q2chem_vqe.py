...
import q2chem
from generate_circuit import generate_quantum_circuit_from_sci, analyze_circuit
import numpy as np
...
#global_phase, qasm_str = qc.to_qasm()
#f = open(qasm_file, "w")
#f.write(qasm_str)
#f.close()
#
#qc_qiskit=QuantumCircuit.from_qasm_file(qasm_file)
#analyze_circuit(qc_qiskit)
...
x0 = np.random.uniform(high=2*np.pi,size=(n_params))
maxiter = 1000
with_grad = False
